...
class AgMonst3R4D(Base4DPipeline):
	...
	def __init__(
		...
		self.monst3r_root_dir = os.path.join(self.ag4D_root_dir, "monst3r")
		self.monst3r_4D_root_dir = os.path.join(self.ag4D_root_dir, "monst3r_4D")
	...
	def develop_static_scene(
		...
		video_static_scene_dir = os.path.join(self.monst3r_4D_root_dir, "static_scenes", video_id)
	...
	def construct_video_4D_data(self, video_id, enable_vis=False):
		...
		"""
		cut3r_video_file_path = os.path.join(self.monst3r_root_dir, f"{video_id[:-4]}.pkl")
