...
Used by AMWAE++ and by WorldWise via the `use_energy_refinement` plugin flag
(I-8); the stability loss activates with `lambda_stability > 0` in the loss.
"""
...
from lib.supervised.components import SpatialPositionalEncoding
