...
# ============================================================================
# Runs the full corrected annotation pipeline for the TEST dataset split.
#
# Prerequisites:
...
# -------------------------------------------------------------------
echo "[Step 5/6] Augmenting test relationships..."
...
# -------------------------------------------------------------------
# Step 6: Combine 4D bboxes + test relationships
# -------------------------------------------------------------------
echo "[Step 6/6] Combining 4D bboxes with augmented test relationships..."
